...
export function CurrentWeatherCard(props) {
  ...
  switch (infoToShow) {
    case "humedad":
      iconInfo = "fontisto:blood-drop";
      height = "70";
      width = "38";
      marg = 1;
      textFieldOne = "Humedad";
      textFieldTwo = `${props.info.current?.humidity !== undefined ? mensajeHumedad + "Humedad" : null}`;
      break;
    case "viento":
      iconInfo = "mdi:weather-windy";
      height = "70";
      width = "70";
      marg = 0;
      textFieldOne = "Viento";
      textFieldTwo = mensajeViento;
      break;
    case "uv":
      iconInfo = "carbon:uv-index-alt";
      height = "70";
      width = "70";
      marg = 0;
      textFieldOne = "Radiación UV";
      textFieldTwo = `${props.info?.current.uvi} UV`;
      break;
    case "sol":
      iconInfo = "mi:sunrise-alt";
      height = "70";
      width = "70";
      marg = 0;
      textFieldOne = "Salida y Puesta de Sol";
      textFieldTwo = mensajeSol;
      break;
    default:
      break;
  }
  ...
  return (
    <Box>
      <CurrentCard>
        <CurrentCardContent>
          <CurrentCardMedia image={process.env.PUBLIC_URL + `/img/${props.info.current?.weather[0].icon}.svg`} />
        </CurrentCardContent>
        <CurrentCardContent>
          <Grid item container sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            <Grid item container>
              <Grid item>
                <CurrentCardDate>{day},</CurrentCardDate>
              </Grid>
              <Grid item>
                <CurrentCardDate sx={{ marginLeft: "0.2em", fontWeight: 450 }}>{date}</CurrentCardDate>
              </Grid>
            </Grid>
          </Grid>
        </CurrentCardContent>
